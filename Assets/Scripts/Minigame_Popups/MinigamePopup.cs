...
public class MinigamePopup : MonoBehaviour
{
    ...
    public float intervalBetweenSpawns = 2.5f;
    public float chanceToSpawn = 0.60f;
    private float accumulatedSpawnChance = 1.1f;
